	...
	public class SimpleMembershipAccountController : Controller
	{
        ...
        public ActionResult Register(IBSSignUP model)
        {
            if (ModelState.IsValid)
            {
                ...
                var token = WebSecurityService.CreateAccount(model.Name, model.Password, requireConfirmationToken: requireEmailConfirmation);
        ...
        private void CreateUserDetails(IBSSignUP model)
        {
